        ...
        <div className={"m-auto mt-12 w-[400px] flex flex-col p-10 border-x-zinc-600 border-1 rounded-sm bg-amber-20 gap-10 "}>
            ...
            <div className={"flex-col gap-2.5"}>
                <label className={"flex flex-col gap-2.5"}>
                    Email:
                    <input onChange={handleInput} value={Login.email} name={"email"} type="email" className="bg-gray-100 border-gray-300 border-2 h-[40px] px-2 rounded-[10px]" placeholder="name@company.com"/>
                </label>

                <label className={"flex flex-col gap-2.5"}>
                    Password:
                    <input onChange={handleInput} value={Login.pass} type="password" id="passwordField" name="pass" placeholder="Enter your password" className="bg-gray-100 border-gray-300 border-2 h-[40px] px-2 rounded-[10px]"/>
                </label>
            </div>
